  ...
  return (
    <>
      ...
      <div className="my-24 text-slate-900 prose xl:prose-xl container max-w-7xl mx-auto">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Stone2stone Limited, Marvan Court, 1
              Waldegrave Rd, Teddington TW11 8LZ.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Stone2stone, accessible from{" "}
              <a
                href="https://www.stone2stone.co.uk"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.stone2stone.co.uk
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@stone2stone.co.uk</li>
        </ul>
      </div>
    </>
  );
