export default function DMSlider2() {
  return (
    <>
            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <p className="text-s2s-gray font-medium">
                  Generating engaging and relevant{" "}
                  <span className="text-black">
                    {" "}
                    content consistently across various digital platforms can be
                    overwhelming.
                  </span>
                </p>
              </div>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    ...
                    <span className="text-black">
                      {" "}
                      aligned with your brand's messaging and audience
                      interests.
                    </span>{" "}
                  </li>
                  <li>
                    Invest in a mix of formats such as
                    <span className="text-black">
                      {" "}
                      videos, blogs, infographics, and social media posts.
                    </span>{" "}
                  </li>
                </ul>
              </div>
            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    <span className="text-black">
                      Collaborate with our skilled content team{" "}
                    </span>{" "}
                    to ideate and produce high-quality content.
                  </li>
                  <li>
                    <span className="text-black">
                      Utilise content management systems
                    </span>{" "}
                    to schedule and distribute content efficiently.
                  </li>
                  <li>
                    <span className="text-black">
                      {" "}
