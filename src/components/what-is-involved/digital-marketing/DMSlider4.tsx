export default function DMSlider4() {
  return (
    <>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <p className="text-s2s-gray font-medium">
                  ...
                  <span className="text-black">
                    effectiveness of digital campaigns and allocating resources
            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    <span className="text-black">
                      Set up conversion tracking to measure specific actions{" "}
                    </span>{" "}
                    (e.g., purchases, sign-ups) resulting from campaigns.
                  </li>
                  <li>
                    <span className="text-black">Analyse data regularly</span>{" "}
                    to identify trends, successes, and areas for improvement.
                  </li>
                  <li>
                    <span className="text-black">Adjust strategies</span> based
                    on real-time insights to maximise ROI.
                  </li>
                </ul>
              </div>
