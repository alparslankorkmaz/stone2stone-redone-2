            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <p className="text-s2s-gray font-medium">
                  Designing gamified experiences that{" "}
                  <span className="text-black">
                    cater to a diverse user base and consider accessibility
                  </span>{" "}
                  needs is crucial.
                </p>
              </div>
            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    Prioritise inclusive design principles by
                    <span className="text-black">
                      {" "}
                      considering different demographics, cultures, and
                      abilities.
                    </span>
                  </li>
                  <li>
                    Conduct accessibility audits to
                    <span className="text-black">
                      {" "}
                      ensure that gamified elements are usable by all users.
                    </span>{" "}
                  </li>
                </ul>
              </div>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    ...
                    to design gamified experiences that comply with
                    accessibility guidelines.
                  </li>
                  <li>
                    <span className="text-black">
                      {" "}
                      Provide customisation options that
                    </span>{" "}
                    allow users to adjust settings based on their preferences
                    and needs.
                  </li>
                  <li>
                    {" "}
                    <span className="text-black">
                      Regularly test your gamified experiences
                    </span>{" "}
                    with diverse user groups to identify and address potential
                    barriers.
                  </li>
                </ul>
              </div>
