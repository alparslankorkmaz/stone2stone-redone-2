export default function GSlider3() {
  return (
    <>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <p className="text-s2s-gray font-medium">
                  ...
                  <span className="text-black">
                    {" "}
                    resistant to engaging with gamified experiences
                  </span>{" "}
                  or may perceive them as gimmicky.
                </p>
              </div>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    ...
                    <span className="text-black">
                      {" "}
                      benefits of gamification to users,
                    </span>{" "}
                    emphasising how it enhances their experience.
                  </li>
                  <li>
                    Design
                    <span className="text-black">
                    ...
                    that make the gamified elements seamless and enjoyable.
                  </li>
                </ul>
              </div>
              {/* BUTTONS */}
            ...
            <div className="p-3 lg:p-5 grid grid-cols-5 gap-3 lg:justify-center lg:items-center">
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    <span className="text-black">
                      Use onboarding tutorials or tooltips
                    </span>{" "}
                    to introduce users to the gamified features and explain
                    their benefits.
                  </li>
                  <li>
                    <span className="text-black">
                    ...
                    into the existing user journey to ensure a smooth and
                    natural integration.
                  </li>
                  <li>
                    <span className="text-black">
                    ...
                    on the design based on their preferences and suggestions.
                  </li>
                </ul>
              </div>
