export default function ABMSlider4() {
  return (
    <>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <p className="text-s2s-gray font-medium">
                  ...
                  <span className="text-black">
                    seamless collaboration and communication between sales and
                    marketing teams
                  </span>{" "}
                  is crucial for ABM success.
                </p>
              </div>
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    ...
                    to align on campaign strategies, goals, and progress.
                  </li>
                  <li>
                    Implement a
                    <span className="text-black">
                    ...
                    to share insights and outcomes between teams.
                  </li>
                </ul>
              </div>
              {/* BUTTONS */}
              ...
              <div className="col-span-4 flex gap-8 flex-col justify-center text-sm lg:text-2xl p-4 lg:p-10">
                ...
                <ul className="list-disc list-inside text-s2s-gray font-medium">
                  <li>
                    ...
                    to track account interactions and engagement.
                  </li>
                  <li>
                    <span className="text-black">
                      Set up lead scoring mechanisms{" "}
                    </span>{" "}
                    to prioritise accounts based on engagement levels and
                    readiness to buy.
                  </li>
                  <li>
                    <span className="text-black">
                    ...
                    through joint planning sessions and shared performance
                    metrics.{" "}
                  </li>
                </ul>
              </div>
